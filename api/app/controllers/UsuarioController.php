...
class UsuarioController extends Controller
{
    ...
    /**
     * Obtiene estadísticas de cajeros (ventas hoy, monto hoy)
     */
    public function estadisticasCajeros(): void
    {
        header('Access-Control-Allow-Origin: *');
        header('Access-Control-Allow-Methods: GET, OPTIONS');
        header('Access-Control-Allow-Headers: Content-Type, Authorization');
        ...
        try {
            $db = Database::connection();
            $stmt = $db->prepare("CALL pa_estadisticas_cajeros()");
            $stmt->execute();
    ...
    /**
     * Obtiene estadísticas de repartidores (entregas hoy, monto hoy)
     */
    public function estadisticasRepartidores(): void
    {
        header('Access-Control-Allow-Origin: *');
        header('Access-Control-Allow-Methods: GET, OPTIONS');
        header('Access-Control-Allow-Headers: Content-Type, Authorization');
        ...
        try {
            $db = Database::connection();
            $stmt = $db->prepare("CALL pa_estadisticas_repartidores()");
            $stmt->execute();
